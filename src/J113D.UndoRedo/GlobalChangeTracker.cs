...
{
	/// <summary>
	/// A global instance of the change tracker for ease of use in a project
	/// </summary>
	[DebuggerStepThrough]
	public static class GlobalChangeTracker
	{
		/// <summary>
		/// The currently active global change tracker
		/// </summary>
		...
		/// <summary>
		/// Swaps the active global change tracker for another one
		/// </summary>
