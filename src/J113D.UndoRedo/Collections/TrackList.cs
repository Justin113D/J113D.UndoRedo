...
{
	/// <summary>
	/// A list wrapper that automatically tracks changes
	/// </summary>
	...
	public class TrackList<T> : IList<T>, IReadOnlyList<T>
	{
		...
		/// <summary>
		/// Creates a new track list that wraps around a list
		/// </summary>
		...
		/// <summary>
		/// Creates a new track list that wraps around a new list
		/// </summary>
		/// <param name="tracker">The change tracker to use</param>
